...
> 📖 配套教程：[E01 Claude Code 教程系列](../tutorials/e01-claude-code/)（6 篇，从安装到 Subagents 动态工作流）
...
5. [Hooks 自动化](../tutorials/e01-claude-code/05-hooks-automation.md) — 生命周期钩子与确定性逻辑
6. [Subagents 子代理与动态工作流](../tutorials/e01-claude-code/06-subagents-and-workflows.md) — 子代理隔离与大规模委托
