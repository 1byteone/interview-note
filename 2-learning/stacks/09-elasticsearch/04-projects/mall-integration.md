...
|------|--------------|--------------------------------|
| ES 搜索架构 | 本文 mall-integration | [08-ES-SEARCH.md](../../../../5-research/tech-stack-analysis/mall-micro-cloud/08-ES-SEARCH.md) — ES 商品搜索服务 |
| AI 向量搜索 | — | [06-VECTOR-STORE.md](../../../../5-research/tech-stack-analysis/mall-ai-search/06-VECTOR-STORE.md) — RedisVL 向量检索 |
| ES vs 向量搜索对比 | — | [00-OVERVIEW.md](../../../../5-research/tech-stack-analysis/mall-micro-cloud/00-OVERVIEW.md) — 两种搜索范式全景 |
