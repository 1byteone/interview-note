...
|------------------|------------|-----------|
| ES 商品搜索架构 | [08-ES-SEARCH.md](../../../5-research/tech-stack-analysis/mall-micro-cloud/08-ES-SEARCH.md) | mall-es-service 搜索接口 |
| 向量搜索 (RedisVL) | [06-VECTOR-STORE.md](../../../5-research/tech-stack-analysis/mall-ai-search/06-VECTOR-STORE.md) | HNSW 索引 + Embedding |
| ES vs 向量搜索对比 | [00-OVERVIEW.md](../../../5-research/tech-stack-analysis/mall-micro-cloud/00-OVERVIEW.md) | 关键词搜索 vs 语义搜索 |
| MySQL→ES 数据同步 | [09-DATA-SYNC.md](../../../5-research/tech-stack-analysis/mall-ai-search/09-DATA-SYNC.md) | SQLAlchemy + tiktoken + 向量化 |
...
| ← 上一篇 | 📚 目录 | 下一篇 → |
|----------|---------|----------|
| [← RocketMQ](../08-rocketmq/README.md) | [📚 总目录](../../README-learning.md) | [Docker →](../10-docker/README.md) |
