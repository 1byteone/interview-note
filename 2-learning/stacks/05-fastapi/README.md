...
本 learn 文档提供理论基础，以下 `5-research/tech-stack-analysis/` 文档提供**真实项目中的落地代码**：

| 本 learn 核心内容 | 对应项目剖析 | 重点看什么 |
|------------------|------------|-----------|
| FastAPI 路由/异常处理 | [02-API-GATEWAY.md](../../../5-research/tech-stack-analysis/mall-ai-search/02-API-GATEWAY.md) | FastAPI 路由 + Pydantic v2 + 全局异常 |
| Pydantic 多 Provider 配置 | [03-CONFIG-MULTI-PROVIDER.md](../../../5-research/tech-stack-analysis/mall-ai-search/03-CONFIG-MULTI-PROVIDER.md) | pydantic-settings 嵌套配置 + 策略模式 |
| Java→Python 桥接 | [12-AI-SEARCH-BRIDGE.md](../../../5-research/tech-stack-analysis/mall-micro-cloud/12-AI-SEARCH-BRIDGE.md) | FeignClient 调用 Python 服务 |