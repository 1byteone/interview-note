...
| ← 上一篇 | 📚 目录 | 下一篇 → |
|----------|---------|----------|
| [← 开发工具](../13-dev-tools/README.md) | [📚 总目录](../../README-learning.md) | [RAG →](../15-rag/README.md) |
...
|------------------|------------|-----------|
| Agent + Tool + Structured Output | [07-LANGCHAIN-AGENT.md](../../../5-research/tech-stack-analysis/mall-ai-search/07-LANGCHAIN-AGENT.md) | `create_agent` + `@tool` + `response_format` |
| Checkpointer 记忆管理 | [08-LANGGRAPH-MEMORY.md](../../../5-research/tech-stack-analysis/mall-ai-search/08-LANGGRAPH-MEMORY.md) | InMemorySaver + thread_id 会话隔离 |
| LLM 多供应商切换 | [04-LLM-PROVIDER.md](../../../5-research/tech-stack-analysis/mall-ai-search/04-LLM-PROVIDER.md) | 阿里云通义千问 + Agnes AI + OpenAI 兼容 |
| Java Spring AI 对标 | [01-LLM-CLIENT.md](../../../5-research/tech-stack-analysis/text2sql/01-LLM-CLIENT.md) | Spring AI ChatClient 对接 DeepSeek |