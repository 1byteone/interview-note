...
| ← 上一篇 | 📚 目录 | 下一篇 → |
|----------|---------|----------|
| [← RAG](../15-rag/README.md) | [📚 总目录](../../README-learning.md) | [AI 智能商城 →](../../projects/ai-mall/README.md) |
...
|------------------|------------|-----------|
| OpenAI 兼容协议接入 | [04-LLM-PROVIDER.md](../../../5-research/tech-stack-analysis/mall-ai-search/04-LLM-PROVIDER.md) | 阿里云通义千问 + Agnes AI + `enable_thinking=False` |
| Embedding 多供应商 | [05-EMBEDDING.md](../../../5-research/tech-stack-analysis/mall-ai-search/05-EMBEDDING.md) | BGE-M3 + SiliconFlow + OpenRouter 切换 |
| Structured Output | [07-LANGCHAIN-AGENT.md](../../../5-research/tech-stack-analysis/mall-ai-search/07-LANGCHAIN-AGENT.md) | `response_format=PydanticModel` 结构化输出 |
| SQL 验证器 | [05-SQL-VALIDATOR.md](../../../5-research/tech-stack-analysis/text2sql/05-SQL-VALIDATOR.md) | 四层验证：语法/安全/语义/性能 |