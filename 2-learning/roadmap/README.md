...
| 项目 | 语言 | 篇数 | 核心方向 | 路径 |
|------|------|------|---------|------|
| **mall-exercise** | Java | 7 篇 | AOP/反射/集合/Redis/MP | [→ 查看](../../5-research/tech-stack-analysis/mall-exercise/01-AOP-PRACTICE.md) |
| **mall-micro-cloud** | Java | 13 篇 | 微服务/分布式/高并发 | [→ 查看](../../5-research/tech-stack-analysis/mall-micro-cloud/00-OVERVIEW.md) |
| **mall-ai-search** | Python | 11 篇 | AI 搜索/Agent/向量检索 | [→ 查看](../../5-research/tech-stack-analysis/mall-ai-search/00-OVERVIEW.md) |
| **text2sql** | Java | 7 篇 | Java AI/RAG/SQL 验证 | [→ 查看](../../5-research/tech-stack-analysis/text2sql/00-OVERVIEW.md) |
...
| ← 上一篇 | 📚 目录 | 下一篇 → |
|----------|---------|----------|
| [🏠 返回项目根目录](../README-learning.md) | [📚 总目录](../README-learning.md) | [后端开发总纲 →](../stacks/01-backend-development/README.md) |