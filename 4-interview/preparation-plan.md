...
| 资源 | 路径 | 说明 |
|------|------|------|
| 16 技术栈学习路径 | [`../2-learning/`](../2-learning/) | 每个技术栈按「入门→核心→进阶→项目→面试」组织 |
| 学习路线总纲 | [`../2-learning/roadmap/`](../2-learning/roadmap/) | 16 栈全景 + 三条学习路线 + 双体系关联索引 |
| 项目实战剖析 (38 篇) | [`../5-research/tech-stack-analysis/`](../5-research/tech-stack-analysis/) | 4 个项目深度剖析，含代码+面试题+Java 对照 |
| 面试计划 | 本文件 | 3 个月系统准备计划 |
...
| 项目 | 语言 | 篇数 | 核心方向 | 路径 |
|------|------|------|---------|------|
| **mall-exercise** | Java | 7 篇 | AOP/反射/集合/Redis/MP | [`mall-exercise/`](../5-research/tech-stack-analysis/mall-exercise/) |
| **mall-micro-cloud** | Java | 13 篇 | 微服务/分布式/高并发 | [`mall-micro-cloud/`](../5-research/tech-stack-analysis/mall-micro-cloud/) |
| **mall-ai-search** | Python | 11 篇 | AI 搜索/Agent/向量检索 | [`mall-ai-search/`](../5-research/tech-stack-analysis/mall-ai-search/) |
| **text2sql** | Java | 7 篇 | Java AI/RAG/SQL 验证 | [`text2sql/`](../5-research/tech-stack-analysis/text2sql/) |
