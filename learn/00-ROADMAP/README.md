...
|---|------|--------|------|----------|----------|----------|----------|
| 01 | 🌐 | 后端开发基础 | ★☆☆☆☆ | 3 天 | 无 | 理解商城的架构分层 | 待编写 |
| 02 | ☕ | Java 核心 | ★★☆☆☆ | 5 天 | 01 | 商城后端主体语言 | 待编写 |
| 03 | 🚀 | Spring Boot | ★★★☆☆ | 5 天 | 02 | 商城的服务端框架 | 待编写 |
| 04 | 🐍 | Python 基础 | ★★☆☆☆ | 4 天 | 无 | AI 服务端语言 | 待编写 |
...
| 11 | 🐧 | Linux | ★★☆☆☆ | 3 天 | 无 | 商城服务器环境 | 待编写 |
| 12 | 🏗️ | 基础设施 | ★★★★☆ | 4 天 | 10/11 | CI/CD、监控、网关 | 待编写 |
| 13 | 🛠️ | 开发工具 | ★☆☆☆☆ | 2 天 | 无 | Git、IDE、调试 | 待编写 |
...
### Phase 1：基础组（5 栈）— 预计 2 周

| 技术栈 | 核心目标 | 商城产出 | 每日投入 |
|--------|----------|----------|----------|
| 01 后端开发基础 | 理解架构分层、API 设计、RESTful | 绘制商城架构图 | 2h × 3 天 |
| 02 Java 核心 | 集合、并发、JVM 基础 | 编写商城基础 POJO | 2h × 5 天 |
| 04 Python 基础 | 语法、类型系统、标准库 | 编写 AI 服务脚本 | 2h × 4 天 |
| 11 Linux | 常用命令、Shell、权限 | 配置开发环境 | 2h × 3 天 |
| 13 开发工具 | Git 工作流、IDE 调试 | 初始化仓库 | 1h × 2 天 |

### Phase 2：后端核心组（5 栈）— 预计 3 周

| 技术栈 | 核心目标 | 商城产出 | 每日投入 |
|--------|----------|----------|----------|
| 03 Spring Boot | 自动配置、Starter、Security | 搭建商城后端服务 | 2h × 5 天 |
| 06 MySQL | 索引优化、事务、SQL 调优 | 设计商城数据库表 | 2h × 5 天 |
| 07 Redis | 缓存策略、分布式锁、持久化 | 商品缓存、购物车 | 2h × 4 天 |
| 08 RocketMQ | 消息模型、事务消息、顺序消息 | 订单异步处理 | 2h × 3 天 |
| 09 Elasticsearch | 索引、分词、聚合查询 | 商品搜索功能 | 2h × 3 天 |

### Phase 3：AI 核心组（4 栈）— 预计 3 周

| 技术栈 | 核心目标 | 商城产出 | 每日投入 |
|--------|----------|----------|----------|
| 10 Docker | 镜像、容器、Compose | 容器化商城服务 | 2h × 3 天 |
| 05 FastAPI | 异步接口、Pydantic 校验 | 搭建 AI 网关服务 | 2h × 3 天 |
| 14 LangChain | Chain、Agent、Memory | 智能客服 Agent | 2h × 4 天 |
| 15 RAG | 文档加载、向量存储、检索 | 商品知识库问答 | 2h × 3 天 |
| 16 OpenAI API | Chat、Embedding、Function Call | LLM 接入 | 2h × 3 天 |

### Phase 4：基础设施组（2 栈 + 贯穿项目）— 预计 2 周

| 技术栈 | 核心目标 | 商城产出 | 每日投入 |
|--------|----------|----------|----------|
| 12 基础设施 | CI/CD、监控、网关 | 全链路部署 | 2h × 4 天 |
| 贯穿项目 | 全栈集成、压测、优化 | 完成商城交付 | 3h × 6 天 |
