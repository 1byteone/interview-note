...
| 技术栈 | 核心目标 | 商城产出 | 状态 |
|--------|----------|----------|------|
| 03 Spring Boot | 自动配置、Starter、Security | 搭建商城后端服务 | 脚手架完成，16 文件 |
| 06 MySQL | 索引优化、事务、SQL 调优 | 设计商城数据库表 | 脚手架完成，16 文件 |
| 07 Redis | 缓存策略、分布式锁、持久化 | 商品缓存、购物车 | 脚手架完成，16 文件 |
| 08 RocketMQ | 消息模型、事务消息、顺序消息 | 订单异步处理 | 脚手架完成，15 文件 |
