...
> 系列导航：本文是《RAG 技术栈深度剖析》系列第 5 篇。前文我们分析了[文本切分与向量化](./03-chunking-strategies.md)、[对话记忆管理](./04-embedding-models.md)，现在进入 RAG 管线的核心存储层——向量数据库。下一篇将探讨[混合检索与 Rerank 重排](./06-retrieval-rerank.md)。
