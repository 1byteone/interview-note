...
新增 **[`tutorials/`](tutorials/README.md)** 深度教程目录（28 篇，覆盖 E01-E06 六大生态 + 跨生态对比专题），从仓库导航升级为可系统学习的教程内容体系：

| 生态 | 教程数 | 核心主题 |
|------|--------|----------|
| [E01 Claude Code](tutorials/e01-claude-code/) | 6 篇 | 安装基础 / Skills 开发 / MCP 集成 / Agent Teams / Hooks 自动化 / Subagents |
| [E02 Codex](tutorials/e02-codex/) | 4 篇 | 快速上手 / AGENTS.md+沙箱 / 高级工作流 / 多 Agent 并行工作树 |
...
| [E05 MCP 协议](tutorials/e05-mcp/) | 4 篇 | 协议概念 / Server 开发 / Client 部署 / MCP 2.0 迁移 |
| [E06 通识与基础](tutorials/e06-general/) | 6 篇 | Prompt / 设计模式 / 生产系统 / LangGraph 编排 / 高级 RAG / Agent 评估 |
| [跨生态对比](tutorials/cross-ecosystem/) | 1 篇 | Coding Agent 横评（Claude Code vs Codex vs Gemini CLI） |
...
│   ├── e01-claude-code/            # E01 Claude Code（6 篇）
│   ├── e02-codex/                  # E02 Codex（4 篇）
│   ├── e03-dsh-harness/            # E03 DSH/Harness（3 篇）
│   ├── e04-hermes-openclaw/        # E04 Hermes/OpenClaw（3 篇）
│   ├── e05-mcp/                    # E05 MCP 协议（4 篇）
│   ├── e06-general/                # E06 通识与基础（6 篇）
│   └── cross-ecosystem/           # 跨生态对比（1 篇）
