...
> ⭐ 6,132 | 🗣 TypeScript | [GitHub](https://github.com/heilcheng/awesome-agent-skills) | 收录: 2026-08-22
...
Agent Skills 教程、指南和目录合集。

### 独特价值

- 覆盖 Claude, Codex, GitHub Copilot, OpenAI 多生态
- 官方中的 Skills 目录索引

## 阅读建议

- **适合人群**: Skills 开发者、使用多 Coding Agent 的用户
---
