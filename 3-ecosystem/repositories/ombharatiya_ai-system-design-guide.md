...
> ⭐ 2,729 | 🗣 N/A | [GitHub](https://github.com/ombharatiya/ai-system-design-guide) | 收录: 2026-08-22
...
AI 系统设计 Staff 级面试参考，Living Document。

### 章节结构

1. LLM 原理
2. 模型选型与定价
3. 训练与适配（微调/LoRA/RLVR）
4. 推理优化
5. RAG（分块/向量库/GraphRAG/Agentic RAG）
6. Agentic 系统（MCP 2.0/A2A）
7. 记忆分层
8. 框架（LangGraph/DSPy/Claude Code）
9. MLOps/FinOps
10. 安全与治理
11. 评估与可观测性
12. 多模态
