...
> ⭐ 4,605 | 🗣 Python | [GitHub](https://github.com/zebbern/claude-code-guide) | 收录: 2026-08-22
...
Claude Code 全功能单文件超级手册，社区维护。

### 内容体量

- 3,656 行单文件（约 30,000 词）
- HTTPOnly 零依赖零构建
