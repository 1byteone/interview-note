...
> ⭐ 2,427 | 🗣 Python | [GitHub](https://github.com/bcefghj/ai-agent-interview-guide) | 收录: 2026-08-22
...
- 9 大模块 200+ 道八股文
- Python/Java/Go 三语言企业级项目
- 简历模板 + STAR 面试稿
- 哆啦 A 梦漫画图解核心概念

### 技术栈

- Python: FastAPI + LangChain + Milvus
- Java: Spring Boot 3 + Spring AI
- Go: Gin
